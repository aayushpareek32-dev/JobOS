...
| 来源 | 公司 | 岗位 | 地点 | 薪资 | 类型 |
|------|------|------|------|------|------|
| Boss直聘 | **华为** | AI工程师实习生（大模型/NLP方向） | 武汉东湖高新区 | 300-350元/天 | 暑期实习 |
| Boss直聘 | **华为** | 智能体算法研究实习生 | 武汉东湖高新区 | 300-350元/天 | 暑期实习 |
| Boss直聘 | **腾讯** | 青云计划-大模型/智能体方向实习 | 武汉/深圳/北京 | 200元/天+补贴 | 暑期实习 |
| Boss直聘 | **字节跳动** | Seed-大模型研究实习生 | 北京/杭州/武汉 | 400-600元/天 | 暑期实习 |
| Boss直聘 | **百度** | NLP/大模型算法实习生 | 武汉光谷/北京 | 250-350元/天 | 暑期实习 |
| Boss直聘 | **小米** | 大模型应用开发实习生 | 武汉/北京 | 250-350元/天 | 暑期实习 |
| 牛客网 | **阿里云** | AI Agent 开发工程师 | 杭州 | 500-510元/天 | 暑期实习 |
| 牛客网 | **淘天集团** | AI Agent应用开发工程师-2026暑期实习 | 杭州 | 300-600元/天 | 暑期实习 |
| 猎聘 | **武汉光谷AI公司** | AI Agent 开发工程师实习 | 武汉光谷 | 200-300元/天 | 日常实习 |
| ... | 还有更多 | ... | ... | ... | ... |
...
```
data/outputs/
├── jobs_20260404_1430.xlsx                          ← Excel（带条件格式 3个Sheet）
├── jobs_20260404_1430.csv                           ← CSV
├── jobs_20260404_1430.json                          ← JSON
...
A: 使用 `python cli.py crawl` 命令实时从 Boss直聘/牛客网/猎聘 爬取最新岗位。批量模式下可设定定时间隔自动更新。
